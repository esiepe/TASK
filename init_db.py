...
# Insert sample data into custom_table
c.execute("INSERT OR IGNORE INTO custom_table (name, description) VALUES ('Item1', 'Description1')")
c.execute("INSERT OR IGNORE INTO custom_table (name, description) VALUES ('Item2', 'Description2')")
